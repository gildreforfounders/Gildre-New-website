...
export const metadata = {
  alternates: { canonical: "https://www.gildre.com/gatherly" },
  ...
  openGraph: {
    ...
    url: "https://www.gildre.com/gatherly",
    siteName: "Gildre",
    type: "website",
    ...
    <div style={{ backgroundColor: "#0f1524", minHeight: "100vh" }}>
      ...
      >
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.55)" }}>
            ...
            cities, time zones, and chapters. When we can&rsquo;t be at the same table, Gatherly is
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="mt-5 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.55)" }}>
                Gatherly is not a webinar tool. It&rsquo;s a spatial, room-based virtual events
                platform where attendees move between rooms, bump into people, and have the
                kinds of conversations that don&rsquo;t happen on a Zoom call with 50 people in
                gallery view.
              </p>
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 items-center">
            ...
            <div>
              ...
              <p className="mt-5 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.55)" }}>
                ...
                networking, and small-group roundtables. Gatherly&rsquo;s agenda system lets
                attendees see what&rsquo;s live, what&rsquo;s next, and where to go, all without needing
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.55)" }}>
                ...
                of 415 concurrent attendees. That&rsquo;s the kind of engagement data that most
                virtual platforms don&rsquo;t surface at all. For a community built on the quality
      ...
      <section className="px-6 py-20" style={{ backgroundColor: "#080e1a" }}>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-fraunces)" }}
          >
            Most virtual platforms make you feel like you&rsquo;re watching an event. Gatherly makes
            you feel like you&rsquo;re at one. That&rsquo;s the difference between a community and an audience,
            and it&rsquo;s the only reason we partnered with them.
          </p>
      ...
      >
        <p>
          ...
          {" · "}
          <Link href="/partners" className="underline underline-offset-2 hover:text-zinc-400 transition-colors">
            Partner Network
          </Link>
        </p>
      </div>
