...
export const metadata = {
  ...
  description:
    "Gildre connects Los Angeles founders with curated peer matches, mentorship, and investor access. Join the founder community built for LA's consumer brand and creator economy ecosystem.",
};
