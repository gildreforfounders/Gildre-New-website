...
const episodes = [
  ...
  {
    number: 31,
    title: "From NASA Mars Missions to Y Combinator: Building ChatOpenSource",
    guest: "ChatOpenSource Founder",
    role: "Founder, ChatOpenSource · Y Combinator",
    date: "Apr 2024",
    duration: "45 min",
    description:
      "This founder worked on NASA's Curiosity and Maven Mars missions, scaled Deliv from zero to one million deliveries per day before its Target acquisition, then founded ChatOpenSource through Y Combinator — an open-source alternative to ChatGPT built for enterprises in legal, healthcare, and financial sectors with strict data privacy requirements.",
