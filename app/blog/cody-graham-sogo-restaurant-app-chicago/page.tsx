  ...
  return (
    <div style={{ backgroundColor: "#0f1524", minHeight: "100vh" }}>
      ...
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <Quote>
          "Keep the main thing the main thing — to quote Super Bowl MVP Jalen Hurts. You can get inundated with all this stuff and just be frozen with decision paralysis. But if you have an idea, be open to feedback. Take the feedback that&apos;s good, that you think is right. And ultimately, stay focused. If you have a goal, go for it."
        </Quote>
        <Body>
