  ...
  return (
    <div style={{ backgroundColor: "#0f1524", minHeight: "100vh" }}>
      ...
      <article className="mx-auto max-w-3xl px-6 py-16">
        ...
        <Body>
          The earliest imprint, he says, is the key. The thing you most disliked as a child — not necessarily a trauma, but a clear "not this" — contains, when flipped, the seed of your meaning. For him, being the outsider who didn&apos;t belong became the driver to create belonging for others. In healthcare, in capital markets, in the communities of accomplished people who came to him asking "what do I do with my life?" — the expression changed. The motivation didn&apos;t.
        </Body>
        <Quote>
