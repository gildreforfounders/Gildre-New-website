          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.5)" }}>
                Gildre NYC events run the full range — from intimate curated dinners to escape rooms, co-hosted startup events, and seasonal BBQs. Every format is designed for one thing: getting the right people in the right room.
              </p>
