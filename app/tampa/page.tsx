...
export const metadata = {
  alternates: { canonical: "https://www.gildre.com/tampa" },
  title: "Founder Community Tampa | Gildre",
  description:
    "Gildre connects Tampa founders through 1:1 matchmaking, operator mentorship, and private dinners. Built for healthtech, SaaS, cybersecurity, and defense-tech builders in the Tampa Bay area.",
  keywords: [
    "Tampa founder community",
    "Tampa startup network",
    "Tampa entrepreneurs",
    "Gildre Tampa",
    "Tampa Bay founders",
    "healthtech founders Tampa",
    "SaaS founders Tampa",
    "Tampa startup dinners",
    "founder peer groups Tampa",
    "Tampa tech founders",
    "cybersecurity founders Tampa",
    "Channelside startup community",
  ],
  openGraph: {
    title: "Founder Community Tampa | Gildre",
    description:
      "Active 1:1 matchmaking, expert operator mentorship, and private founder dinners for Tampa Bay's healthtech, SaaS, cybersecurity, and defense-tech builders.",
  ...
  "@graph": [
    {
      ...
      areaServed: [{ "@type": "City", name: "Tampa" }, { "@type": "Country", name: "United States" }],
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "How are 1:1 founder introductions curated in Tampa?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Every week, Gildre's team actively reviews your profile, stage, and goals to match you with a specific Tampa Bay founder or operator who is solving a complementary problem or has relevant experience. These are warm, intentional intros, not algorithm-generated requests you have to cold-follow up on.",
          },
        },
        {
          "@type": "Question",
          name: "Where are Tampa founder dinners and events held?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "We host monthly founder dinners and curated events throughout Tampa Bay. Venues rotate across the metro — Downtown, Channelside, Hyde Park, and beyond — so wherever you're based, you're in range.",
          },
        },
        {
          "@type": "Question",
          name: "What types of founders join Gildre's Tampa Chapter?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Gildre Tampa welcomes founders across all industries, from healthtech and cybersecurity to SaaS, defense-tech, and consumer. The community is defined less by vertical and more by mindset: you are actively building, serious about peer accountability, and ready to give as much as you get. Members typically range between the Build (<$500K) and Growth ($5M+ ARR) stages.",
          },
        },
        {
          "@type": "Question",
          name: "How is Gildre different from Embarc Collective or other Tampa startup communities?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Gildre is a curated private membership, not an open coworking hub or events calendar. You are selected, matched, and actively facilitated. Every introduction, dinner, and roundtable is built around you specifically, not general networking. Embarc Collective is a great physical ecosystem; Gildre is the high-signal peer layer on top of it.",
          },
        },
        {
          "@type": "Question",
          name: "Can I attend a Tampa event before becoming a member?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Occasionally Gildre opens select Tampa events to prospective members by invitation. The best path is to apply and mention your interest in Tampa events. We often prioritize local applicants for preview dinners so you can experience the community firsthand before committing.",
          },
        },
      ],
    },
...
const memberTraits = [
  ...
  },
  {
    ...
    description:
      "Healthtech, SaaS, cybersecurity, defense, consumer, services. Gildre Tampa has members building across all of it. The filter isn't your sector. It's whether you're serious enough to be useful to someone else.",
  },
  {
...
const faqItems = [
  {
    q: "How are 1:1 founder introductions curated in Tampa?",
    a: "Every week, Gildre's team actively reviews your profile, stage, and goals to match you with a specific Tampa Bay founder or operator who is solving a complementary problem or has directly relevant experience. These are warm, intentional introductions, not algorithm-generated requests you have to cold-follow up on.",
  },
  {
    q: "Where are Tampa founder dinners and events held?",
    a: "We host monthly founder dinners and curated events throughout Tampa Bay. Venues rotate across the metro — Downtown, Channelside, Hyde Park, and Westshore — so no matter where you're based, you're in range.",
  },
  {
    q: "What types of founders join Gildre's Tampa Chapter?",
    a: "Gildre Tampa welcomes founders across all industries, from healthtech and cybersecurity to SaaS, defense-tech, and consumer brands. The community is defined less by vertical and more by mindset: you are actively building, serious about peer accountability, and ready to give as much as you get. Members typically range between the Build (<$500K) and Growth ($5M+ ARR) stages.",
  },
  {
    q: "How is Gildre different from Embarc Collective or other Tampa startup communities?",
    a: "Gildre is a curated private membership, not an open coworking hub or events calendar. Every introduction, dinner, and roundtable is built around you specifically. Embarc Collective is a great physical space for Tampa's ecosystem; Gildre is the high-signal peer layer that operates inside and beyond it.",
  },
  {
    q: "Can I attend a Tampa event before becoming a member?",
    a: "Occasionally Gildre opens select Tampa events to prospective members by invitation. The best path is to apply and mention your interest in a Tampa preview dinner. We regularly prioritize local applicants so you can experience the community firsthand before committing.",
  },
];
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
            ...
            <div className="relative h-80 overflow-hidden rounded-2xl lg:h-96" style={{ border: "1px solid rgba(201,169,110,0.12)" }}>
              ...
              <div className="absolute bottom-5 left-5">
                ...
                <p className="mt-0.5 text-[0.65rem]" style={{ color: "rgba(255,255,255,0.5)" }}>Channelside, Tampa</p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.5)" }}>
                Gildre Tampa events run the full range — from intimate curated dinners to team experiences, co-hosted startup events, and seasonal gatherings. Every format is designed for one thing: getting the right people in the right room.
              </p>
                ...
                {[
                  {
                    ...
                    detail: "Seated. Small. Every attendee selected. Twelve founders around a good table — no panels, no pitching. The conversations here don't happen anywhere else in Tampa because the room was built for them.",
                  },
                  {
                    title: "Team Building Experiences",
                    detail: "Off-sites and challenges designed to build trust faster than a conference ever could. The best peer relationships start when you're solving something together.",
                  },
                  {
                    title: "Co-Hosted Events with Other Startups",
                    detail: "Gildre partners with top Tampa Bay startups and ecosystem organizations to co-host events. Curated cross-pollination — access to complementary communities, not just ours.",
                  },
                  {
                    title: "Social Gatherings",
                    detail: "Some of the best founder relationships start over good food and Tampa sunshine. Gildre hosts seasonal social events where the agenda is just being around the right people.",
                  },
                ].map((ev) => (
      ...
      <section className="px-6 py-24" style={{ backgroundColor: "#0f1524", borderTop: "1px solid rgba(255,255,255,0.04)" }}>
        <div className="mx-auto max-w-5xl">
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-fraunces)" }}
          >
            Meet the team leading Gildre&rsquo;s Tampa Chapter.
          </h2>
