            ...
            <div>
              ...
              <ul className="mt-7 flex flex-col gap-5">
                {[
                  ...
                  { title: "Peer Operator Roundtables", detail: "Quarterly deep-dives on Bay Area-specific scaling challenges — AI product differentiation, enterprise sales cycles, recruiting against FAANG — facilitated by operators who have navigated the same terrain." },
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl px-8 py-10 sm:px-12" style={{ backgroundColor: "rgba(201,169,110,0.05)", border: "1px solid rgba(201,169,110,0.18)" }}>
            ...
            <h2 className="mt-3 text-[1.5rem] font-bold leading-snug text-white sm:text-[1.9rem]" style={{ fontFamily: "var(--font-fraunces)" }}>
              Built for Seed-to-Series A founders, deep-tech operators, and high-growth builders in the Bay Area.
            </h2>
            <p className="mt-4 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.5)" }}>
